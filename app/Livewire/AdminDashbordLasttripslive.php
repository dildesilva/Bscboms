...
class AdminDashbordLasttripslive extends Component

{
    ...
    public function render()
    {
        try {
            ...
            $this->latast = Tripcreatemodel::with('user')->where('status', 'completed')
                ->latest('updated_at')
                ->take(5)
                ->get();
        ...
        return view('livewire.admin-dashbord-lasttripslive', [
            'trips' => $this->trips,
