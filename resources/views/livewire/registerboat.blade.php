...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        {{-- Boat Name --}}
        <div>
            <label class="block text-xs font-medium text-gray-700 mb-1">Boat Name</label>
            <input type="text" wire:model="boatName" readonly
                placeholder="{{ Auth::user()->name }}"
                class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm
                       focus:outline-none focus:ring-2 focus:ring-indigo-500
                       focus:border-transparent transition placeholder-gray-400">
            @error('boatName') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
        </div>

        {{-- Boat ID --}}
        <div>
            <label class="block text-xs font-medium text-gray-700 mb-1">Boat ID</label>
            <input type="text" wire:model="boatId" readonly
        ...
        <div>
            ...
            <input type="text" wire:model="registrationNumber"
                ...
                class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm
                       focus:outline-none focus:ring-2 focus:ring-indigo-500
                       focus:border-transparent transition placeholder-gray-400">
            @error('registrationNumber') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
        </div>

        {{-- Hull ID --}}
        <div>
            <label class="block text-xs font-medium text-gray-700 mb-1">Hull ID</label>
            <input type="text" wire:model="hullId"
                placeholder="e.g. HID-00123"
                class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm
                       focus:outline-none focus:ring-2 focus:ring-indigo-500
                       focus:border-transparent transition placeholder-gray-400">
            @error('hullId') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
        </div>
        ...
        {{-- Boat Length --}}
        <div>
            <label class="block text-xs font-medium text-gray-700 mb-1">Boat Length (m)</label>
            <input type="text" wire:model="length"
        ...
        {{-- Max Crew Capacity --}}
        <div>
            <label class="block text-xs font-medium text-gray-700 mb-1">Max Crew Capacity</label>
            <input type="text" wire:model="maxCrew"
                placeholder="e.g. 8"
                class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm
                       focus:outline-none focus:ring-2 focus:ring-indigo-500
                       focus:border-transparent transition placeholder-gray-400">
            @error('maxCrew') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
        </div>

        {{-- Boat Type --}}
        <div>
            <label class="block text-xs font-medium text-gray-700 mb-1">Boat Type</label>
            <select wire:model="boattype"
            ...
            @error('boattype') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
        </div>

        {{-- Engine Model --}}
        <div>
            <label class="block text-xs font-medium text-gray-700 mb-1">Engine Model</label>
            <input type="text" wire:model="enginemodel"
        ...
        {{-- Engine Type — FIXED: was wire:model="boattype" --}}
        <div>
            <label class="block text-xs font-medium text-gray-700 mb-1">Engine Type</label>
            ...
            @error('engineType') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
        </div>

        {{-- Engine Power --}}
        <div>
            <label class="block text-xs font-medium text-gray-700 mb-1">Engine Power</label>
            <input type="text" wire:model="enginePower"
                placeholder="e.g. 300 HP"
                class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm
                       focus:outline-none focus:ring-2 focus:ring-indigo-500
                       focus:border-transparent transition placeholder-gray-400">
            @error('enginePower') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
        </div>

    </div>
</div>
{{-- END: Boat Information --}}
            ...
            >
                <span wire:loading.remove>Register Boat</span>
